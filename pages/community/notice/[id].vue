<template>
  <div class="detail-box" v-if="noticeInfo">
    <div class="d-flex flex-row-reverse">
      <VBtn icon="mdi-microsoft-xbox-controller-menu" theme="light" class="v-btn--blank" @click="() => $router.push('/community/notice')"></VBtn>
    </div>
...
async function loadDetail() {
  noticeInfo.value = await $fetch('/api/notice', {
    params: {
      id: route.params.id,
      update: 'true',
    },
